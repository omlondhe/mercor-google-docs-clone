    ...
    <div className="toolbarTopRight">
      ...
      <Tooltip title="username@gmail.com">
        <Avatar
          ...
          alt="User avatar"
          src="https://media.licdn.com/dms/image/D5635AQHrLRnWOdUpAw/profile-framedphoto-shrink_400_400/0/1683001032402?e=1685095200&v=beta&t=0qd0cnsoKa59joPIdQ8FCygyt6_bWXpc7iLxYtgVrM8"
        />
      </Tooltip>
    </div>
  );
